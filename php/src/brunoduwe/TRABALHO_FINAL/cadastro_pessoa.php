        ...
        <nav class="navbar navbar-dark bg-dark fixed-top shadow-lg p-3 mb-5 menu">
            ...
            <div class="conteudo">
                ...
                <div class="p-1 rounded bg-secondary float-left">
                    <a href="cadastro_usuario.php" class="btn btn-secondary btn-sm" id="usuario">Usuário</a>
                    <a href="cadastro_cliente.php" class="btn btn-secondary btn-sm" id="cliente">Cliente</a>   
                </div>
                <div class="container conteudo">
                    <h5>Cadastro de Pessoa:</h5>
                    <p class="text-primary alert alert-primary">
                    Com o cadastro de usuário você pode dar acesso a novos usuarios ao seu sistema com um cadastro simples e seguro que visa dar
                    autonomia a varios usuarios acessarem o sistema simultaneamente.
                    </p>
                    <h5>Cadastro de Cliente:</h5>
                    <p class="text-primary alert alert-primary">
                    Com o cadastro de cliente você adiciona clientes ao sistema onde voce pode ter acesso futuramente ao contato desta pessoa e possibilitando 
                    tambem armarzenar mercadorias para esta pessoa.
                    </p>
                </div>
                <hr>
            </div>
